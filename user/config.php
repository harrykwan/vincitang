...
define( 'YOURLS_DB_USER', 'vincitang.hk' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'vincixdd' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'urls' );
...
define( 'YOURLS_SITE', 'https://info.vincitang.hk' );
